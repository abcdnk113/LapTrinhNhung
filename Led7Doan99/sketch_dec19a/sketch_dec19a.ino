...
void dis(int num)
{
  for (int i = 2; i < 9; i++)
  {
    digitalWrite(i, bitRead(digit[num], i - 2)); //bitRead trả về giá trị tại một bit i của một số nguyên tương ứng với các chân a,b,c,d,e,f,g tương ứng vơi i chạy từ 2-9 đổi với arduino
  }
}
